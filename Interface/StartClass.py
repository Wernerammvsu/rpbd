...
class start_page:
    ...
    def clicked_login_chose(self):
        ...
        self.label=Label(master=self.window, bg="gray22", font="Ariel 14", text='Добро пожаловать')
    ...
    def clicked_register_chose(self):
        ...
        self.login_text = Label(master=self.frame_register, text="Логин", bg="gray22", fg="white", font="Arial 11", width=18, anchor=W)
        ...
        self.password_text = Label(master=self.frame_register, text="Пароль", bg="gray22", fg="white", font="Arial 11", width=18, anchor=W)
        ...
        self.confirm_password_text= Label(master=self.frame_register, text="Повторите пароль", bg="gray22", fg="white", font="Arial 11", width=18, anchor=W)
    ...
    def login_clicked(self):
        ...
        if user[0]:
            id = self.con.execute(
            "select id from User where login = '" + login + "' and password = '" + password + "'").fetchone()[0]
            self.clear_screen()
            if user[1]:
                admin_page(self.con, self.window, id)
            else:
                home_page(self.con, self.window, id)
